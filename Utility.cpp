...
//============================================================================================
// Adds to polynomials and returns their sum as a polynomial.
////============================================================================================
//Polynomial Add(const Polynomial poly1, const Polynomial poly2)
//{
//    Polynomial first = poly1;
//    Polynomial last = poly2;
//    
//
//}
//Polynomial Add(const Polynomial Poly1, const Polynomial Poly2)
...
//    temp2 = Poly2;
//    
//    string polynomial_sum = "";
//    int sums[MAXIMUM_AMOUNT_OF_POLY_NOMIALS + 1];
//    
//    for (int i = 0; i < MAXIMUM_AMOUNT_OF_POLY_NOMIALS; i++)
//        sums[i] = 0;
//    
//    while(temp1.head)
//    {
//        sums[temp1.head->Exponent] += temp1.head->Coefficient;
//        temp1.head = temp1.head->Next_Term;
//    }
//    
//    while(temp2.head)
//    {
//        sums[temp2.head->Exponent] += temp2.head->Coefficient;
//        temp2.head = temp2.head->Next_Term;
//    }
//    
//    for (int i = MAXIMUM_AMOUNT_OF_POLY_NOMIALS; i >= 0; i--)
//    {
//        if (sums[i] >= 0)
//        {
//            polynomial_sum += "+" + to_string(sums[i]) + VARIABLE + to_string(i);
//        }
//        
//        else
//        {
...
//        polynomial_sum += " ";
//    }
//    polynomial_sum.erase(polynomial_sum.length() - 1);
//    cout << polynomial_sum << endl;
//    Polynomial final_sum(polynomial_sum);
//    return final_sum;
//}
